...
const SOCIALS = [
  {
    id: 'instagram', label: 'Instagram', href: 'https://instagram.com/', color: '#E1306C',
    icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4.5"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>,
  },
  {
    id: 'twitter', label: 'X', href: 'https://x.com/', color: '#e2e8f0',
    icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.745l7.73-8.835L1.254 2.25H8.08l4.258 5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>,
  },
  {
    id: 'linkedin', label: 'LinkedIn', href: 'https://linkedin.com/', color: '#0A66C2',
    icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-4 0v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>,
  },
  {
  ...
  {
    id: 'tiktok', label: 'TikTok', href: 'https://tiktok.com/', color: '#e2e8f0',
    icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.34 6.34 0 0 0-6.34 6.29 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.76a4.85 4.85 0 0 1-1.01-.07z"/></svg>,
  },
  {
    id: 'whatsapp', label: 'WhatsApp', href: 'https://wa.me/', color: '#25D366',
    icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.127.558 4.123 1.532 5.855L.057 23.09a.5.5 0 0 0 .617.636l5.428-1.424A11.953 11.953 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 0 1-5.003-1.37l-.359-.213-3.72.976.995-3.634-.234-.374A9.818 9.818 0 1 1 12 21.818z"/></svg>,
  },
];
...
function SocialBtn({ social, index }) {
  ...
  return (
    <motion.a
      ...
      transition={{ delay: 0.7 + index * 0.055, duration: 0.32, ease: [0.16, 1, 0.3, 1] }}
      ...
      style={{
        ...
        flexShrink: 0, textDecoration: 'none', position: 'relative', overflow: 'hidden',
...
function StatCard({ val, labelKey, t, delay }) {
  return (
    ...
    >
      ...
      <div style={{
        fontSize: 9, color: P.textLow, marginTop: 6,
...
function FeatureRow({ emoji, labelKey, t, index }) {
  ...
  return (
    <motion.div
      ...
      transition={{ delay: 0.38 + index * 0.07, duration: 0.36, ease: 'easeOut' }}
      onMouseEnter={() => setHov(true)}
      onMouseLeave={() => setHov(false)}
      style={{
    ...
    >
      ...
      <motion.div
        ...
        style={{
          width: 2.5, height: 20, borderRadius: 2, flexShrink: 0,
...
export default function AuthBrandSide({ mode, t: tProp }) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', minHeight: 0 }}>
      ...
      {/* Mid accent orb */}
      <motion.div
        animate={{ x: [-10, 10, -10], y: [0, -16, 0], opacity: [0.07, 0.13, 0.07] }}
      ...
      {[260, 360, 460].map((sz, i) => (
        <div key={i} style={{
          position: 'absolute', bottom: -sz * 0.55, right: -sz * 0.55,
      ...
      <motion.div
        ...
        style={{
          ...
          background: P.lavender, opacity: 0.22,
      ...
      <div style={{
        ...
        height: '100%', display: 'flex', flexDirection: 'column', maxWidth : "700px",
        ...
        <motion.div
          ...
          style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 'clamp(24px, 3.8vh, 42px)' }}
        >
          {/* Logo tile */}
          <div style={{
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div style={{
              ...
              <span style={{ width: 6, height: 6, borderRadius: '50%', background: P.lavender, display: 'inline-block' }} />
              <span style={{ fontSize: 9.5, fontWeight: 700, color: P.lavender, letterSpacing: '0.14em', textTransform: 'uppercase' }}>
                {isSignin ? t('brand.mode_signin') ?? 'Sign In' : t('brand.mode_signup') ?? 'Get Started'}
              </span>
            </div>
            ...
            <p style={{
              ...
              color: P.textMid, lineHeight: 1.78, maxWidth: 330,
            }}>
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 'clamp(14px, 2.2vh, 22px)' }}>
          {STATS.map((s, i) => (
            <StatCard key={s.key} val={s.val} labelKey={s.key} t={t} delay={0.28 + i * 0.08} />
          ))}
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
          {FEATURES.map((f, i) => (
            <FeatureRow key={f.key} emoji={f.emoji} labelKey={f.key} t={t} index={i} />
          ))}
        </div>
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
            ...
            <span style={{
              fontSize: 9, fontWeight: 700, color: P.textLow,
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, flexWrap: 'wrap' }}>
            {SOCIALS.map((s, i) => <SocialBtn key={s.id} social={s} index={i} />)}
          </div>
        </motion.div>
