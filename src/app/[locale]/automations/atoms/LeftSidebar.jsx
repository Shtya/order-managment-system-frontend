        ...
        <div className="contents">
            ...
            {collapsed && (
                <button
                    ...
                    className="absolute top-[80px] start-4 h-10 w-10 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-full shadow-lg flex items-center justify-center z-20 hover:scale-110 transition-all"
                >
            ...
            <aside
                className={cn(
                    "flex flex-col h-full bg-white dark:bg-slate-950 border-r dark:border-slate-800 overflow-hidden",
                    ...
                    collapsed
                        ...
                        : "translate-x-0 w-[280px] sm:w-[300px] opacity-100 shadow-2xl lg:shadow-none"
                )}
            >
                {/* Header */}
