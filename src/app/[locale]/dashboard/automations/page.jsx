...
export default function AutomationsPage() {
  ...
  const statsCards = useMemo(
    () => [
      { name: t("stats.all"), value: MOCK_STATS.total, icon: Play, color: "#3b82f6" },
      { name: t("stats.published"), value: MOCK_STATS.published, icon: CheckCircle, color: "#10b981" },
      { name: t("stats.pausedAll"), value: MOCK_STATS.paused, icon: AlertCircle, color: "#ef4444" },
    ],
    [t]
  );
            ...
            actions={[
              {
                ...
                onClick: (r) => router.push(`/dashboard/automations/detail/${r.id}`),
                variant: "primary",
              ...
              },
              {
                ...
                onClick: (r) => router.push(`/dashboard/automations/edit/${r.id}`),
                variant: "purple",
        ...
        buttons={
          <>
            <Button_
              ...
              variant="solid"
              onClick={() => router.push("/dashboard/automations/builder")}
              icon={<Plus size={18} />}
