        ...
        <motion.div  {...fadeUp(0.1)} className="w-full max-w-xl mx-auto flex justify-center items-center relative">
          <svg viewBox="0 0 600 600" className="w-full h-auto">
            ...
            <g><circle cx="300" cy="120" r="45" fill="white" stroke="var(--primary)" strokeWidth="3"></circle>
              ...
              <path d="M 290 115 Q 290 105, 300 105 Q 310 105, 310 115 L 310 125 M 288 120 L 288 130 Q 288 133, 291 133 L 294 133 M 306 133 L 309 133 Q 312 133, 312 130 L 312 120" stroke="var(--primary)" strokeWidth="2" fill="none" strokeLinecap="round"></path><text x="300" y="145" textAnchor="middle" fill="var(--primary)" className="text-[10px]" style={{ fontWeight: 600 }}>{t("hero.callCenter")}</text></g><g><circle cx="480" cy="300" r="45" fill="white" stroke="var(--primary)" strokeWidth="3"></circle>
              <circle cx="480" cy="300" r="35" fill="color-mix(in srgb, var(--primary), white 95%)"></circle>
              <rect x="465" y="290" width="30" height="25" fill="none" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></rect><path d="M 465 295 L 480 285 L 495 295 M 480 285 L 480 315" stroke="var(--primary)" strokeWidth="2" fill="none" strokeLinecap="round"></path><text x="480" y="330" textAnchor="middle" fill="var(--primary)" style={{ fontWeight: 600 }} className="text-[10px]">{t("hero.warehouse")}</text></g><g><circle cx="300" cy="480" r="45" fill="white" stroke="var(--primary)" strokeWidth="3"></circle>
              ...
              <path d="M 285 475 L 288 475 L 295 497 L 310 497 M 288 475 L 315 475 L 312 485 L 295 485" stroke="var(--primary)" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"></path><text x="300" y="465" textAnchor="middle" fill="var(--primary)" style={{ fontWeight: 600 }} className="text-[10px]">{t("hero.orders")}</text></g><g><circle cx="120" cy="300" r="45" fill="white" stroke="var(--primary)" strokeWidth="3"></circle>
