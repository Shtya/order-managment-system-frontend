                ...
                >
                    <div className="relative inline-block">
                        ...
                        <motion.div
                            ...
                            className="absolute -top-2 -right-2 w-12 h-12 rounded-full bg-orange-400 dark:bg-orange-500 flex items-center justify-center shadow-lg"
                        >
                            <AlertTriangle size={24} className="text-white dark:text-gray-900" />
                        </motion.div>
                    </div>
                    <motion.h1
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-3 p-4  rounded-xl border border-border">
                            ...
                            <div>
                                <p className="text-xs text-foreground">{t("labels.status")}</p>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        ...
                                        <div>
                                            <span className="text-foreground">{t("labels.paymentStatus")}:</span>{" "}
