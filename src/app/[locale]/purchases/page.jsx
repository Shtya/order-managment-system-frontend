					...
					{loading ? (
						...
						<div className="space-y-4 sm:space-y-5">
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								{safe && (
									<div className="p-4 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800 dark:to-slate-800 border border-gray-200 dark:border-slate-700 flex items-center justify-between sm:col-span-2">
										<div className="flex items-center gap-3">
											<div className="w-10 h-10 rounded-xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
												<Wallet className="w-5 h-5 text-blue-600 dark:text-blue-400" />
											</div>
											<div>
												<p className="text-xs font-bold text-gray-700 dark:text-slate-300">{safe.name}</p>
												<p className="text-[10px] text-gray-500 dark:text-slate-400 uppercase font-bold">
													{commissionRate > 0 && <span className="ml-1 text-gray-500">({t("commissionRate")}: {commissionRate}%)</span>}
												</p>
											</div>
										</div>
										<div className="text-right">
											<span className="text-[10px] text-gray-500 dark:text-slate-400 uppercase font-bold">
												{t("safeBalance") || "Safe Balance"}
											</span>
											<p className="text-lg font-bold text-gray-900 dark:text-white">{formatCurrency(safe.currentBalance)}</p>
										</div>
									</div>
								)}

								{paidAmount > 0 && (
									<div className="p-4 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800 dark:to-slate-800 border border-gray-200 dark:border-slate-700 flex flex-col gap-3 sm:col-span-2">
										<div className="flex items-center justify-between">
											<div className="flex items-center gap-3">
												<div className="w-10 h-10 rounded-xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
											...
											{!canWithdraw && (
												<Badge variant="destructive">{t("insufficientBalance") || "Insufficient Balance"}</Badge>
											)}
										</div>

										{commissionRate > 0 && (
											<div className="pt-2 border-t border-gray-200 dark:border-slate-700 space-y-1">
												<div className="flex justify-between text-[10px] font-bold uppercase text-gray-500 dark:text-slate-400">
								...
								>
									<div className="flex items-center gap-3">
										...
										<div>
											...
											<div className="text-[10px] sm:text-xs text-gray-500 dark:text-slate-400 font-semibold">{t("acceptPreview.totalQuantity")}</div>
										</div>
									</div>
								</motion.div>
								...
								>
									<div className="flex items-center gap-3">
										...
										<div>
											...
											<div className="text-[10px] sm:text-xs text-gray-500 dark:text-slate-400 font-semibold">{t("acceptPreview.priceUpdates")}</div>
										</div>
									</div>
								</motion.div>
							</div>
							...
							{hasPriceChanges && (
								<motion.div
									...
									animate={{ opacity: 1, y: 0 }}
									className="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800 dark:to-slate-800 border border-gray-200 dark:border-slate-700"
								>
										...
										<div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
											<div className="relative self-center sm:self-start">
												<div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center flex-shrink-0">
													<svg className="w-6 h-6 sm:w-7 sm:h-7 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
											...
											<div className="flex-1 space-y-2 sm:space-y-3 w-full text-center sm:text-start">
												<h4 className="text-sm sm:text-base font-bold text-gray-700 dark:text-slate-200 uppercase tracking-wide">
												...
												<div className="relative group">
													<div className="relative bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-gray-200 dark:border-slate-700">
														<div className="text-[10px] sm:text-sm text-gray-800 dark:text-slate-200 bg-gray-50 dark:bg-slate-800/50 px-3 sm:px-5 py-3 sm:py-4">
															<div className="flex flex-wrap items-center gap-1 sm:gap-2 justify-center text-center">
																<span className="px-2 sm:px-3 py-1 sm:py-1.5 bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-slate-300 rounded-lg sm:rounded-xl font-bold">
															...
															<div className="text-center my-2 sm:my-3">
																<div className="inline-block w-full max-w-[200px] sm:max-w-md h-0.5 bg-gray-300 dark:bg-slate-600"></div>
															</div>
										...
										<tbody className="bg-white dark:bg-slate-900">
											{rows.map((r, idx) => (
												...
												>
													...
													<td className="p-3 sm:p-4 text-center">
														<span className="inline-flex items-center px-2 sm:px-3 py-0.5 sm:py-1 rounded-full bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-slate-300 text-xs sm:text-sm font-bold">
															+{r.addQty || 0}
														</span>
													</td>
													<td className="p-3 sm:p-4 text-center">
													...
													<td className="p-3 sm:p-4 text-center">
														<span className="text-sm sm:text-base font-semibold text-gray-700 dark:text-slate-300">
															{r.incomingAvgCost ?? 0}
														</span>
													</td>
													<td className="p-3 sm:p-4 text-center">
						...
						<div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto order-1 sm:order-2">
							...
							<Button
								...
								className={cn(
									...
									(loading || !preview || hasErrors || !preview?.canApply || !canWithdraw) && "opacity-50 cursor-not-allowed"
								)}
							>
