...
export default function CancelCausesStatisticsPage() {
  ...
  const statsCards = [
    ...
    {
      id: "beforeShippingRate",
      name: t("kpis.beforeShippingCancelRate"),
      value: `${overview?.beforeShippingCancelRate || 0}%`,
      icon: Package,
      description: tTutorial("stats.beforeShippingCancelRate.description"),
      example: tTutorial("stats.beforeShippingCancelRate.example"),
    },
    {
    ...
    {
      id: "afterShippingRateOfShipped",
      name: t("kpis.afterShippingCancelRateOfShipped"),
      value: `${overview?.afterShippingCancelRateOfShipped || 0}%`,
      icon: Truck,
      description: tTutorial("stats.afterShippingCancelRateOfShipped.description"),
      example: tTutorial("stats.afterShippingCancelRateOfShipped.example"),
    },
    {
      id: "orders",
