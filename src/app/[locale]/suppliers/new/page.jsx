...
export default function AddSupplierPage() {
	...
	const categories = [
		...
		{ id: "home_tools", label: t("categories.homeTools") },
	];
	...
	const handleSave = () => {
		console.log("Save supplier:", { ...formData, categories: selectedCategories });
		// Add API call here
	};
	...
	return (
		...
		>
			...
			<div className="bg-card mb-6">
				<div className="flex items-center justify-between">
					...
					<div className="flex items-center gap-2 text-lg font-semibold">
						...
						<button
							onClick={() => navigate.push("/suppliers")}
							className="text-gray-400 hover:text-primary transition-colors"
						>
							{t("breadcrumb.suppliers")}
						</button>
						<ChevronLeft className="text-gray-400" size={18} />
						<span className="text-primary">{t("breadcrumb.addSupplier")}</span>
			...
			{/* Main Form */}
			<motion.div
				className="max-w-4xl mx-auto bg-card"
				...
				<div className="space-y-6">
					...
					<div className="space-y-2">
						...
						<Textarea
							...
							className="min-h-[120px] bg-[#fafafa] dark:bg-slate-800/50 border-gray-200 dark:border-slate-700 rounded-2xl resize-none"
						/>
					</div>
					...
					<div className="space-y-2">
						...
						<Input
							...
							placeholder={t("form.joinDatePlaceholder")}
							className="rounded-full h-[50px] bg-[#fafafa] dark:bg-slate-800/50 border-gray-200 dark:border-slate-700"
						/>
					</div>
