    ...
    sections: [
      {
        title: "1. نطاق الخدمة",
        body: `
          <p>مدار هي منصة متعددة المستخدمين لإدارة عمليات التجارة الإلكترونية وإدارة علاقات العملاء عبر واتساب. نحن نوفر أدوات لإدارة اتصالات العملاء، الطلبات، الشحن، المنتجات، الموردين، وعمليات المتجر. تتكامل خدمتنا مع واجهة برمجة تطبيقات واتساب السحابية من ميتا لتمكين مراسلات الأعمال وإدارة الحسابات.</p>
        `,
      },
      {
      ...
      },
      {
        ...
        body: `
          <p>نحتفظ بالحق في تعليق أو إنهاء الوصول إذا تم انتهاك هذه الشروط، أو إذا طلبت ميتا ذلك، أو إذا تسبب استمرار الوصول في مخاطر قانونية أو أمنية للمنصة أو للمستخدمين الآخرين.</p>
        `,
      },
      {
        title: "8. التواصل",
