...
import OutgoingPDF from "../atoms/OutgoingPDF";
// ─────────────────────────────────────────────
// ─────────────────────────────────────────────────────────────
// DESIGN TOKENS
// ─────────────────────────────────────────────────────────────
    ...
    try {
        ...
        const blob = await pdf(
            <OutgoingPDF
                ...
                employee={employee}
                now={now}
                labels={outgoingPdfLabels}
                locale={locale} // Make sure locale is available in this scope
            />
        ).toBlob();
        ...
        a.href = url;
        a.download = `outgoing_manifest_${id}_${new Date().getTime()}.pdf`;
