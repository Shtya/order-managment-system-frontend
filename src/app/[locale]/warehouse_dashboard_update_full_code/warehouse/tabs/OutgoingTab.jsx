...
function buildOutgoingDocumentBody({ orders, carrier, employee, createdAt, title }) {
    ...
    return `
      <section class="order-card">
        ...
        <div style="padding: 16px; display: flex; flex-direction: column; gap: 16px;">
          ${buildOrderOverviewCards(order, { orderValue: "قيمة الطلب", orderSummary: "ملخص الطلب", customer: "العميل", city: "المدينة", itemsWord: "قطعة" })}
...
function OutgoingFilesSubtab({ deliveryFiles, orders, t }) {
  ...
  const handleOpenFile = (file) => {
    ...
    openPdfDocument({
      ...
      body: buildOutgoingDocumentBody({ orders: snapshot, carrier: file.carrier, employee: file.createdBy, createdAt: file.createdAt, title: t("files.deliveryPdfTitle") }),
    });
  };
