      ...
      <div className="h-full px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <motion.div
            ...
            className="
              flex items-center gap-3 px-3 py-[5px] rounded-md cursor-pointer
              dark:bg-slate-800 bg-white border border-gray-200 dark:border-slate-700
            "
          >
            <div className="w-7 h-7 rounded-full bg-primary1 flex items-center justify-center text-white font-bold">
              {t('profile.initial')}
            </div>

            <div>
              <div className="text-xs font-semibold dark:text-white text-slate-900 text-right">
                {t('profile.greeting')}
              </div>
              <div className="text-xs dark:text-slate-400 text-slate-500 text-right">
                {t('profile.role')}
              </div>
            </div>
          </motion.div>
