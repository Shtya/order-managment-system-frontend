      ...
      <div className="relative h-full px-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1">
          ...
          <Popover>
            ...
            <PopoverContent
              align="end"
              className="w-72 p-0 overflow-hidden rounded-xl shadow-2xl border border-border/50"
            >
              <div className="relative px-4 py-3 border-b border-border/50 overflow-hidden">
                ...
                <p className="text-[11px] text-muted-foreground mt-0.5 relative">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col min-w-0 max-w-[110px] hidden sm:flex">
        ...
        <span
          className="text-[8.5px] font-bold px-1 py-px rounded-full w-fit mt-px
          bg-primary/10 text-primary border border-primary/15"
        >
          {t(`roles.${user?.role?.name || "user"}`)}
        </span>
      </div>
    </motion.div>
  );
    ...
    >
      {hov && (
        <motion.span
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent, color-mix(in oklab, var(--destructive) 15%, transparent), transparent)",
            transform: "skewX(-12deg)",
          }}
        />
      )}
      <motion.span
        animate={{ rotate: hov ? -20 : 0 }}
