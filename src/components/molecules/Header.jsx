...
export default function Header({ toggleSidebar, isSidebarOpen }) {
  ...
  const notifications = useMemo(
    () => [
      { title: t("notif.newOrder.title"), desc: t("notif.newOrder.desc"), time: t("notif.newOrder.time"), unread: true },
      { title: t("notif.stockAlert.title"), desc: t("notif.stockAlert.desc"), time: t("notif.stockAlert.time"), unread: true },
      { title: t("notif.shippingUpdate.title"), desc: t("notif.shippingUpdate.desc"), time: t("notif.shippingUpdate.time"), unread: false },
    ],
    [t]
  );
