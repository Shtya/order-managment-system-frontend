...
function BackCard({ rotateY, rotateX, translateX, translateZ, animDelay }) {
  ...
  return (
    <div
      style={{
        ...
        transition:
          "transform 0.75s cubic-bezier(0.34,1.2,0.64,1), opacity 0.6s ease",
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(135deg, rgba(109,40,217,0.25) 0%, rgba(13,5,32,0.35) 100%)",
          borderRadius: 18,
