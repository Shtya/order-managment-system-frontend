    ...
    <DialogPortal data-slot="dialog-portal ">
      ...
      <DialogPrimitive.Content
        ...
        onInteractOutside={(e) => {
          ...
          // Prevent the modal from closing when you click the getting-started
          // tour tooltip (it renders in a portal on document.body)
          const isGettingStartedClick = e.target.closest(
            "[data-getting-started-tutorial]",
          );
          if (isGettingStartedClick) {
            e.preventDefault();
          }
        }}
